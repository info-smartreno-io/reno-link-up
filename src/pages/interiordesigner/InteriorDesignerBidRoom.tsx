...
import InteriorDesignerBidSubmissionDialog from "@/components/interiordesigner/InteriorDesignerBidSubmissionDialog";
...
export default function InteriorDesignerBidRoom() {
  ...
  useEffect(() => {
    const fetchOpportunities = async () => {
      ...
      try {
        const { data, error } = await supabase
          ...
          .select('*')
          .eq('status', 'open')
          .eq('open_to_interior_designers', true)
    ...
    const opportunitiesChannel = supabase
      .channel('bid-opportunities-designer')
      .on(
        'postgres_changes',
        {
          event: '*',
    ...
    const submissionsChannel = supabase
      .channel('bid-submissions-designer')
      .on(
        'postgres_changes',
        {
          event: '*',
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {user && (
        <>
          <InteriorDesignerBidSubmissionDialog
