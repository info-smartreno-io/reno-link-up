...
export default function GCApplicants() {
  const { data: applicants, isLoading } = useQuery({
    queryKey: ["gc-applicants"],
    queryFn: async () => {
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">General Contractor Applicants</h1>
          <p className="text-muted-foreground mt-2">
            Review general contractor applications
          </p>
        </div>
