    ...
    <footer className="py-10 pt-20 border-t bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-4 text-sm mb-12">
          <div>
            <img src={smartrenoLogo} alt="SmartReno" className="h-10 mb-3" />
            <p className="text-sm font-semibold text-foreground mb-1">SmartReno protects your time, money and home.</p>
            <p className="text-xs text-muted-foreground italic mb-4">The first step before you renovate.</p>
